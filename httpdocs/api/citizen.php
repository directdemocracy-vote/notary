...
$query = "SELECT TO_BASE64(publication.`key`) AS `key`, UNIX_TIMESTAMP(publication.published), TO_BASE64(publication.signature), "
...
$query = "SELECT TO_BASE64(pc.signature), UNIX_TIMESTAMP(pe.published), e.`revoke`, "
