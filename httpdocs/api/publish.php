...
if ($type === 'certificate') {
  ...
  echo json_encode(endorsements($mysqli, $key), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); # FIXME: this is probably not needed (we can remove the require once it is removed)
} else
