...
if ($radius)
  $query .= ", ST_Distance_Sphere(citizen.home, POINT($longitude, $latitude), 6371) AS distance";
#  $query .= ", ST_Distance_Sphere(POINT(ST_X(citizen.home), ST_Y(citizen.home)), POINT($longitude, $latitude)) AS distance";
