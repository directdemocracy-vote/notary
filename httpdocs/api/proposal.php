...
$query = "SELECT publication.id, "
        ...
        ."proposal.question, proposal.answers, proposal.secret, proposal.type, UNIX_TIMESTAMP(proposal.deadline) AS deadline, proposal.trust, proposal.website, "
        ...
        ."INNER JOIN publication AS pa ON pa.id = proposal.area "
        ."INNER JOIN area ON area.publication = pa.id "
